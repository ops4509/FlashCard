...
public class CheckIncorrect extends JDialog {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CheckIncorrect dialog = new CheckIncorrect();
	...
	private JLabel getLblNewLabel() {
		if (lblNewLabel == null) {
			...
			lblNewLabel.setIcon(new ImageIcon(CheckIncorrect.class.getResource("/com/javalec/assets/red phone.png")));
	...
	private JLabel getLblNewLabel_1() {
		if (lblNewLabel_1 == null) {
			lblNewLabel_1 = new JLabel("오답입니다!");
	...
	public void insertScore() {
		...
		daoScore_OKH.insertScoreIncorrect();
	}
